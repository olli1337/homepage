    ...
    <div className={'App'}>
      <div id='container'>
        <div style={{ display: 'flex', flexDirection: 'column', width: '100%', alignItems: 'center', backgroundColor: '#5CDB95', color: '#EDF5E1', fontWeight: 'bold', fontSize: '50px', fontFamily: 'Abel' }}>
          ...
          <div style={{ display: 'flex', padding: '0 5px 0 5px', textShadow: '2px 2px black' }} >Hey, my name is Olli Havilehto</div>
          <div style={{ display: 'flex', padding: '0 5px 0 5px', textShadow: '2px 2px black' }}>I do IT Architecture, programming, and DevOps stuff</div>
          <div style={{ display: 'flex', padding: '0 5px 0 5px', textShadow: '2px 2px black' }}>~~~~~~</div>
        </div>
        <div style={{ display: 'flex', color: 'white', width: '100%', justifyContent: 'center', backgroundColor: '#5CDB95' }}>
